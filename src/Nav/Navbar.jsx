  ...
  return (
    <div className='navber sticky sm:mb-2 sm:bg-sky-200 shadow-2xl mt-4'>
      ...
      <ul className='  relative sm:hidden lg:block'>
        <li className='group text-[#ffa518] hover:bg-[#ffa518] hover:text-white duration-200 ease-linear'><Link to="/">ক্যাম্পাস</Link>
        ...
        <li className='group text-[#686318] hover:bg-[#686318] hover:text-white duration-200 ease-linear'><Link href="/">ভর্তি</Link>
        <ul className='absolute hidden group-hover:block z-1 top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-[#84154d] hover:bg-[#84154d] hover:text-white duration-200 ease-linear'><Link href="/">টেকনোলজিসমূহ </Link>
        ...
        <li  className='group text-green-800 hover:bg-green-800 hover:text-white duration-200 ease-linear'><Link href="/">প্রশাসন</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-blue-600 hover:bg-blue-600 hover:text-white duration-200 ease-linear'><Link href="/">একাডেমিক কার্যক্রম</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-[#694bba] hover:bg-[#694bba] hover:text-white duration-200 ease-linear'><Link href="/">শিক্ষার্থী</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-[#c40a2a] hover:bg-[#c40a2a] hover:text-white duration-200 ease-linear'><Link href="/">ফলাফল</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-green-600 hover:bg-green-600 hover:text-white duration-200 ease-linear'><Link href="/">রিসোর্স</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-[#84154d] hover:bg-[#84154d] hover:text-white duration-200 ease-linear'><Link href="/">গ্যালারি</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-[#0e91e7] hover:bg-[#0e91e7] hover:text-white duration-200 ease-linear'><Link href="/">নোটিশ কর্নার</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
        ...
        <li className='group text-[#c40a2a] hover:bg-[#c40a2a] hover:text-white duration-200 ease-linear'><Link href="/">ই-সেবা</Link>
        <ul className='absolute hidden group-hover:block top-[26px] left-[-50px] w-[300px] flex-col'>
