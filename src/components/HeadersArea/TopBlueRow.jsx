  ...
  return (
    <div className='bg-[#0e91e7] max-w-[960px] w-full h-[40px] truncate flex items-center justify-between sm:[60%] shadow-xl'>
       ...
       <div className='flex items-center'>
        ...
        <Link className='text-white text-[12px] md:text-[15px] ml-1  font-arial ' to="/">icst69016@gmail.com <span className='sm:text-[12px] md:text-[20px] items-center sm:ml-1'>|</span> </Link>
        </div>
